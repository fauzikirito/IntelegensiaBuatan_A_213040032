...
public class AStar {
    ...
    public void search(NodeUCS start, NodeUCS goal) {
        ...
        while (!queue.isEmpty()) {
            ...
            // Pengkondisian jika eval bernilai tujuan/goal, maka semua node tetangga dari eval
            ...
            // Pengkondisian jika eval belum bernilai goal, maka
                ...
                // Suksessor untuk menyimpan node best
                NodeUCS successor = best;
                // Suksessor tersebut dimasukan ke solusiSuksesor
                ...
                // Node eval dimasukkan ke tetangga node suksessor
                solusiSuksesor.getNodes().add(eval.getNode());

                System.out.println();
                // Pesan node terpilih dengan nilai jarak dari node ke goal ditambah jarak antar node
                ...
                // solusiSuksesor dimasukKan ke dalam queue
